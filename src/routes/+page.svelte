...
<div class="container h-full mx-auto flex justify-center items-center">
	<div class="space-y-10 text-center flex flex-col items-center">
		<h2 class="h2 bg-gradient-to-br from-blue-500 to-cyan-300 bg-clip-text text-transparent box-decoration-clone">Welcome to Skeleton.</h2>
		<!-- Animated Logo -->
		<figure>
		...
		<div class="flex justify-center space-x-2">
			<a
				...
				rel="noreferrer"
			>
				<span class="bg-gradient-to-br from-gray-900 to-slate-500 bg-clip-text text-transparent box-decoration-clone">Look at the docs!</span>
			</a>
		</div>
		<div class="space-y-2 bg-gradient-to-br from-blue-500 to-cyan-300 bg-clip-text text-transparent box-decoration-clone">
